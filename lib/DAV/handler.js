...
(function() {
    ...
    this.httpPropfind = async function() {
        ...
        this.getRequestBody("utf8", null, false, function(err, data) {
            ...
            self.parsePropfindRequest(data, async function(err, requestedProperties) {
                if (!Util.empty(err))
                    return self.handleError(err);
                ...
                var newProperties= await self.asyncGetPropertiesForPath(path, requestedProperties, depth)
